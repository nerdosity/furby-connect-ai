...
var _SHARED_TR={
  it:{
    ...
    'wifi.btn_hostname':'<i class="bi bi-floppy"></i> Salva hostname',
    'wifi.hostname_hint':'Raggiungibile su <code>furby.local</code> via mDNS',
    ...
    'llm.btn_save':'<i class="bi bi-floppy"></i> Salva','llm.btn_test':'<i class="bi bi-lightning"></i> Test',
    ...
    'el.btn_save':'<i class="bi bi-floppy"></i> Salva','el.btn_test':'<i class="bi bi-lightning"></i> Test',
    ...
    'ble.btn_save':'<i class="bi bi-floppy"></i> Salva',
    'ble.btn_reset':'<i class="bi bi-arrow-counterclockwise"></i> Ripristina',
    ...
    'cam.stream_quality':'qualità stream','cam.snap_title':'impostazioni snapshot LLM',
    'cam.snap_quality':'qualità snapshot','cam.save_snap':'<i class="bi bi-floppy"></i> Salva','cam.snap_hint':'Risoluzione e qualità usate per catturare il frame inviato all\'LLM. Indipendenti dallo stream.',
    'cam.flicker_none':'nessuno','cam.flicker_50':'50 Hz','cam.flicker_60':'60 Hz',
    ...
    'cam.no_llm_token':'Nessun token LLM configurato - vai alle impostazioni per inserirlo.',
  ...
  en:{
    ...
    'wifi.open':'Open',
    'wifi.label_hostname':'Hostname',
    'wifi.btn_hostname':'<i class="bi bi-floppy"></i> Save hostname',
    'wifi.hostname_hint':'Reachable at <code>furby.local</code> via mDNS',
    ...
    'llm.btn_save':'<i class="bi bi-floppy"></i> Save','llm.btn_test':'<i class="bi bi-lightning"></i> Test',
    ...
    'el.btn_save':'<i class="bi bi-floppy"></i> Save','el.btn_test':'<i class="bi bi-lightning"></i> Test',
    ...
    'ble.label_svc':'Service UUID','ble.label_char':'Characteristic UUID TX',
    'ble.btn_save':'<i class="bi bi-floppy"></i> Save',
    'ble.btn_reset':'<i class="bi bi-arrow-counterclockwise"></i> Restore',
    ...
    'cam.stream_quality':'Stream quality','cam.snap_title':'LLM snapshot settings',
    'cam.snap_quality':'Snapshot quality','cam.save_snap':'<i class="bi bi-floppy"></i> Save','cam.snap_hint':'Resolution and quality used to capture the frame sent to the LLM. Independent from the stream.',
    'cam.flicker_none':'none','cam.flicker_50':'50 Hz','cam.flicker_60':'60 Hz',
    ...
    'cam.tts_browser':'Browser','cam.tts_board':'Board',
    'cam.tts_hint':'Browser: Web Speech API - Board: ElevenLabs via ESP32',
    'cam.no_llm_token':'No LLM token configured - go to settings to add one.',
...
function _updateSysBar(d){
  ...
  var ntpTime = (d.now_ts > 0) ? new Date(d.now_ts * 1000).toLocaleTimeString() : '';
