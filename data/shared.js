...
var _SHARED_TR={
  it:{
    ...
    'llm.btn_save':'<i class="bi bi-floppy"></i> Salva configurazione AI','llm.btn_test':'<i class="bi bi-flask"></i> Test',
    ...
    'el.btn_save':'<i class="bi bi-floppy"></i> Salva ElevenLabs','el.btn_test':'<i class="bi bi-flask"></i> Test',
    ...
    'sd.absent_sub':'Modalità RAM streaming','sd.btn_format':'<i class="bi bi-trash3"></i> Inizializza / Reset cache SD',
  ...
  en:{
    ...
    'llm.btn_save':'<i class="bi bi-floppy"></i> Save AI configuration','llm.btn_test':'<i class="bi bi-flask"></i> Test',
    ...
    'el.btn_save':'<i class="bi bi-floppy"></i> Save ElevenLabs','el.btn_test':'<i class="bi bi-flask"></i> Test',
    ...
    'sd.absent_sub':'RAM streaming mode','sd.btn_format':'<i class="bi bi-trash3"></i> Initialize / Reset SD cache',
